...
main = tkinter.Tk()
main.title("FACIAL EXPRESSIONS IDENTIFICATION BY APPLYING KERAS ") #designing main screen
...
font = ('times', 13, 'bold')
title = Label(main, text='FACIAL EXPRESSIONS IDENTIFICATION BY APPLYING KERAS ')
